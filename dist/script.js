...
/* harmony import */ var _modules_slaiders__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/slaiders */ "./src/js/modules/slaiders.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_slaiders__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', '', '.main-prev-btn', '.main-next-btn');
  Object(_modules_slaiders__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', 'vertical');
...
var accordion = function accordion(triggerSelector) {
  // доступ к кнопкам
  var btns = document.querySelectorAll(triggerSelector); // перебераем и навешиваем событие клик
  ...
  btns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      this.classList.toggle('active-style'); //   тоже самое со следующим элементом контекста

      this.nextElementSibling.classList.toggle('active-content'); //проверяем на наличие класса если true, то работаем с maxHeight
      //устанавливаем его значение scrollHeight + 80pading

      if (this.classList.contains('active-style')) {
        this.nextElementSibling.style.maxHeight = this.nextElementSibling.scrollHeight + 80 + "px"; // если нету ставим maxHeight
      } else {
...
var burger = function burger(menuSelector, burgerSelector) {
  ...
  var menuElem = document.querySelector(menuSelector),
      burgerElem = document.querySelector(burgerSelector); // на всякий случай скрываем меню  

  menuElem.style.display = 'none'; // при клике открытие меню 
...
var calc = function calc(size, material, options, promocod, result) {
  ...
  var sizeBlock = document.querySelector(size),
      ...
      resultBlock = document.querySelector(result); // сюда будем помещять общую сумму  
...
var drop = function drop() {
  var fileInputs = document.querySelectorAll('[name="upload"]'); // навешиваем 4 события
  ...
  function preventDefaults(e) {
    e.preventDefault(); // отмены всплытия
  ...
  function unhighlight(item) {
    item.closest('.file_upload').style.border = "none"; // есть ли родитель с таким класом
  ...
  }); // при попаданий файла в инпут, появляеться его название
...
var filter = function filter() {
  ...
  var typeFilter = function typeFilter(markType) {
    ...
    no.classList.remove('animated', 'fadeIn'); // если передали аргумент,перебераем его выводим на экран
    // и добоаляем класс
...
var pictureSize = function pictureSize(imgSelector) {
  ...
  function showImg(block) {
    // доступ к картинке
    var img = block.querySelector('img'); // меняем название картинки

    img.src = img.src.slice(0, -4) + '-1.png'; // убираем <p> c текстом,кроме хита продаж
  ...
  function hideImg(block) {
    ...
    img.src = img.src.slice(0, -6) + '.png'; // возвращаем текст
...
var scrolling = function scrolling(upSelector) {
  ...
  var upElem = document.querySelector(upSelector); // навишиваем событие,scrollTop - возвращает сколь пользователь 
  ...
  speed = 0.3; // навешиваем событие на каждую ссылку

  links.forEach(function (link) {
    link.addEventListener('click', function (event) {
      event.preventDefault(); //  считываем количество пикселей прокрученных от верха элемента     
      ...
      toBlock = document.querySelector(hash).getBoundingClientRect().top,
          // стартовая позиция
      start = null; // указываем браузеру что хотим произвести анимацию
      ...
      function step(time) {
        ...
        r = toBlock < 0 ? Math.max(widthTop - progress / speed, widthTop + toBlock) : Math.min(widthTop + progress / speed, widthTop + toBlock); // скролим страницу 

        document.documentElement.scrollTo(0, r); // условие для остановки анимаций
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  var btn = document.querySelector(trigger); // подгружаем элементы с сервера
  // fetch возврвщает промис

  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResoursce"])('assets/db.json').then(function (res) {
  ...
  function createCards(response) {
    response.forEach(function (_ref) {
      var src = _ref.src,
          ...
          link = _ref.link;
      // создали див
      var card = document.createElement('div'); // добавляем класс
...
/*!*************************************!*\
  !*** ./src/js/services/requests.js ***!
  \*************************************/
/*! exports provided: postData, getResoursce */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "postData", function() { return postData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getResoursce", function() { return getResoursce; });
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.concat */ "./node_modules/core-js/modules/es.array.concat.js");
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.object.to-string */ "./node_modules/core-js/modules/es.object.to-string.js");
/* harmony import */ var core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_1__);
...
var getResoursce = function getResoursce(url) {
  var res;
  return regeneratorRuntime.async(function getResoursce$(_context2) {
    while (1) {
